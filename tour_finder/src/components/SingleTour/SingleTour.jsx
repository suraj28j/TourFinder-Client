        ...
        <div className='col-md-8 mb-2'>
          ...
          <div className='row border mt-4 ms-1 me-1'>
            ...
            <p className='ms-3'>
              ...
              <span className='ms-4 me-4'><i class="bi bi-currency-dollar"></i> {tours.price} per person</span>
              <span className='ms-4 me-4'><i class="bi bi-geo-alt"></i> {tours.distance} k/m</span>
